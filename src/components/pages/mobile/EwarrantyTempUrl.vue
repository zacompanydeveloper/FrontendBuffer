    ...
    <MobileLayout>
        <div>
                ...
                <div class="w-full flex z-40">
                    <div class="flex items-center justify-between p-2  w-full">
                        <div class="" @click="backFun">
                            <i class="pi pi-arrow-left text-[var(--base-color)] text-xl" />
                        </div>

                        <p class=" font-bold text-center text w-full">
            ...
            <div class=" w-full flex justify-center p-5" v-if="!loading">
                <div class=" bg-white shadow-lg border border-gray-100 rounded-lg w-[500px] p-5 flex flex-col gap-1"
                    v-if="isSuccess">
                    ...
                    <!-- Customer Info -->
                    <div>
                        <p class="text font-bold text-[var(--base-color)]">
                            {{ $t('customer_information') }}
                        </p>
                        <table class=" w-full my-3 border text-xs divide-y">
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('name') }}
                                </td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.customerName }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('phone') }}
                                </td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.customerPhone }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('address') }}
                                </td>
                                <td class=" p-1 bg-[var(--light-color)] text-xs">{{ formData.customerAddress }}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div>
                        ...
                        <table class=" w-full my-3 border text-xs divide-y">
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('order_date') }}</td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.orderDate }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('product') }}</td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.product }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('lot_number') }}</td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.lotNumber }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('category') }}</td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.category }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('location') }}</td>
                                <td class=" p-1 bg-[var(--light-color)] text-xs">{{ formData.location }}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div>
                        ...
                        <table class=" w-full my-3 border text-xs divide-y">
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('warranty_type') }}
                                </td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.warrantyType }}</td>
                            </tr>
                            <tr>
                                <td class=" w-[30%] bg-[var(--base-color)] text-white p-1">{{ $t('warranty_period') }}
                                </td>
                                <td class=" p-1 bg-[var(--light-color)]">{{ formData.warrantyPeriod }}</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class=" flex flex-col gap-5" v-if="!status">
                        <p class="text-xs text-gray-600 my-3">
                        ...
                        <div class=" flex justify-center">
                            <input type="checkbox" id="agreement" class="mr-1 bg-[var(--base-color)]"
                                v-model="agreed" />
                            <p class=" text-xs">
                                I have agree to the warranty terms&conditions.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="flex w-full flex-row-reverse" v-if="agreed && !status">
                        <button class="w-[48%] bg-[var(--base-color)] text-white py-3 p-1 mt-3 rounded-lg text-sm" @click="activateFun">
                            {{ $t('warranty_activate') }}
                        </button>
                    </div>
